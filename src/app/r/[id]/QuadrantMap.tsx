  ...
  return (
    <div className="mt-4 rounded-2xl border p-4">
      ...
      <div className="relative mt-3 aspect-square w-full overflow-hidden rounded-xl bg-white">
        ...
        {/* 축 라벨 */}
        <div className="absolute left-3 top-3 text-xs text-gray-500 dark:text-gray-400">습(습함)</div>
        <div className="absolute left-3 bottom-3 text-xs text-gray-500 dark:text-gray-400">조(건조)</div>
        <div className="absolute left-3 top-1/2 -translate-y-1/2 text-xs text-gray-400 dark:text-gray-500">
          한(차가움) ←
        </div>
